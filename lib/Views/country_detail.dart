...
//                                       },
//                                       size: 50,
//                                       likeCount: ref.watch(favoriteManagerProvider).getFavoriteCount(name),
...
class CountryDetail extends ConsumerWidget {
  ...
  const CountryDetail({required this.name, required this.iso2, required this.userId});
                          ...
                          if (snapshot.hasError) {
                            ...
                            return Row(
                              ...
                              children: [
                                ...
                                FutureBuilder<int>(
                                  future: favoriteController.getFavoriteCount(name),
                                      ...
                                      return LikeButton(
                                        ...
                                        onTap: (isLiked) async {
                                          if (!isLiked) {
                                            ...
                                            showToast(
                                              message:
                                                  'Remove $name from favorites complete');
                                          }
                                          return !isLiked;
                                        },
                                        size: 50,
                                        likeCount: null, // Đợi giá trị
                                        countPostion: CountPostion.bottom,
                                      );
                                    } else if (likeCountSnapshot.hasError) {
                                      return Text(
                                          'Error: ${likeCountSnapshot.error}');
                                    } else {
                                      final likeCount =
                                      ...
                                      return LikeButton(
                                        ...
                                        onTap: (isLiked) async {
                                          if (!isLiked) {
                                            ...
                                            showToast(
                                              message:
                                                  'Add $name to favorite successful');
                                          } else {
                                            await ref
                                                .read(favoriteManagerProvider)
                                                .removeFromFavorite(name);
